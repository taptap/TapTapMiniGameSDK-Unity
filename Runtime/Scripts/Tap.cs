...
namespace TapTapMiniGame
{
    ...
    public partial class Tap: TapBase
    {
        ...
        {
            TapSDKManagerHandler.Instance.AddCard(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.AuthPrivateMessage(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.Authorize(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.CheckIsAddedToMyMiniProgram(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.CheckSession(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ChooseImage(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ChooseMedia(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ChooseMessageFile(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.CloseBLEConnection(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.CloseBluetoothAdapter(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.CompressImage(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.CreateBLEConnection(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.CreateBLEPeripheralServer(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ExitMiniProgram(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ExitVoIPChat(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.FaceDetect(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetAvailableAudioSources(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetBLEDeviceCharacteristics(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetBLEDeviceRSSI(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetBLEDeviceServices(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetBLEMTU(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetBackgroundFetchData(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetBackgroundFetchToken(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetBatteryInfo(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetBeacons(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetBluetoothAdapterState(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetBluetoothDevices(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetChannelsLiveInfo(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetChannelsLiveNoticeInfo(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetClipboardData(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetConnectedBluetoothDevices(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetExtConfig(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetFuzzyLocation(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetGameClubData(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetGroupEnterInfo(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetInferenceEnvInfo(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetLocalIPAddress(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetNetworkType(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetPrivacySetting(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetScreenBrightness(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetScreenRecordingState(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetSetting(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetShareInfo(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetStorageInfo(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetSystemInfo(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetSystemInfoAsync(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetUserInfo(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetUserInteractiveStorage(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetWeRunData(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.HideKeyboard(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.HideLoading(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.HideShareMenu(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.HideToast(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.InitFaceDetect(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.IsBluetoothDevicePaired(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.JoinVoIPChat(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.Login(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.MakeBluetoothPair(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.NavigateToMiniProgram(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.NotifyBLECharacteristicValueChange(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OpenAppAuthorizeSetting(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OpenBluetoothAdapter(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OpenCard(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OpenChannelsActivity(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OpenChannelsEvent(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OpenChannelsLive(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OpenChannelsUserProfile(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OpenCustomerServiceChat(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OpenCustomerServiceConversation(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OpenPrivacyContract(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OpenSetting(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OpenSystemBluetoothSetting(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.PreviewImage(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.PreviewMedia(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ReadBLECharacteristicValue(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.RemoveStorage(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.RemoveUserCloudStorage(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ReportScene(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.RequestMidasFriendPayment(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.RequestMidasPayment(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.RequestSubscribeMessage(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.RequestSubscribeSystemMessage(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.RequirePrivacyAuthorize(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.RestartMiniProgram(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SaveFileToDisk(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SaveImageToPhotosAlbum(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ScanCode(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SetBLEMTU(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SetBackgroundFetchToken(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SetClipboardData(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SetDeviceOrientation(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SetEnableDebug(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SetInnerAudioOption(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SetKeepScreenOn(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SetMenuStyle(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SetScreenBrightness(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SetStatusBarStyle(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SetUserCloudStorage(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SetVisualEffectOnCapture(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ShowActionSheet(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ShowKeyboard(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ShowLoading(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ShowModal(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ShowShareImageMenu(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ShowShareMenu(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ShowToast(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.StartAccelerometer(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.StartBeaconDiscovery(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.StartBluetoothDevicesDiscovery(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.StartCompass(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.StartDeviceMotionListening(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.StopAccelerometer(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.StopBeaconDiscovery(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.StopBluetoothDevicesDiscovery(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.StopCompass(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.StopDeviceMotionListening(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.StopFaceDetect(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.UpdateKeyboard(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.UpdateShareMenu(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.UpdateVoIPChatMuteConfig(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.UpdateTaptapApp(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.VibrateLong(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.VibrateShort(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.WriteBLECharacteristicValue(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.StartGameLive(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.CheckGameLiveEnabled(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetUserCurrentGameliveInfo(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetUserRecentGameLiveInfo(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.GetUserGameLiveDetails(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OpenChannelsLiveCollection(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OpenBusinessView(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ExitPointerLock();
        }
        ...
        {
            TapSDKManagerHandler.Instance.OperateGameRecorderVideo(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.RemoveStorageSync(key);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ReportEvent(eventId, data);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ReportMonitor(name, value);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ReportPerformance(id, value, dimensions);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ReportUserBehaviorBranchAnalytics(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.RequestPointerLock();
        }
        ...
        {
            TapSDKManagerHandler.Instance.ReserveChannelsLive(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.RevokeBufferURL(url);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SetPreferredFramesPerSecond(fps);
        }
        ...
        {
            TapSDKManagerHandler.Instance.SetStorageSync(key, data);
        }
        ...
        {
            TapSDKManagerHandler.Instance.ShareAppMessage(option);
        }
        ...
        {
            TapSDKManagerHandler.Instance.TriggerGC();
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnAccelerometerChange(result);
        }

        public static void OffAccelerometerChange(Action<OnAccelerometerChangeListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffAccelerometerChange(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnAudioInterruptionBegin(res);
        }

        public static void OffAudioInterruptionBegin(Action<GeneralCallbackResult> res)
        {
            TapSDKManagerHandler.Instance.OffAudioInterruptionBegin(res);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnAudioInterruptionEnd(res);
        }

        public static void OffAudioInterruptionEnd(Action<GeneralCallbackResult> res)
        {
            TapSDKManagerHandler.Instance.OffAudioInterruptionEnd(res);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnBLEConnectionStateChange(result);
        }

        public static void OffBLEConnectionStateChange(Action<OnBLEConnectionStateChangeListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffBLEConnectionStateChange(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnBLEMTUChange(result);
        }

        public static void OffBLEMTUChange(Action<OnBLEMTUChangeListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffBLEMTUChange(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnBLEPeripheralConnectionStateChanged(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OffBLEPeripheralConnectionStateChanged(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnBackgroundFetchData(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnBeaconServiceChange(result);
        }

        public static void OffBeaconServiceChange(Action<OnBeaconServiceChangeListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffBeaconServiceChange(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnBeaconUpdate(result);
        }

        public static void OffBeaconUpdate(Action<OnBeaconUpdateListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffBeaconUpdate(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnBluetoothAdapterStateChange(result);
        }

        public static void OffBluetoothAdapterStateChange(Action<OnBluetoothAdapterStateChangeListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffBluetoothAdapterStateChange(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnBluetoothDeviceFound(result);
        }

        public static void OffBluetoothDeviceFound(Action<OnBluetoothDeviceFoundListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffBluetoothDeviceFound(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnCompassChange(result);
        }

        public static void OffCompassChange(Action<OnCompassChangeListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffCompassChange(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnDeviceMotionChange(result);
        }

        public static void OffDeviceMotionChange(Action<OnDeviceMotionChangeListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffDeviceMotionChange(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnDeviceOrientationChange(result);
        }

        public static void OffDeviceOrientationChange(Action<OnDeviceOrientationChangeListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffDeviceOrientationChange(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnError(error);
        }

        public static void OffError(Action<Error> error)
        {
            TapSDKManagerHandler.Instance.OffError(error);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnHide(res);
        }

        public static void OffHide(Action<GeneralCallbackResult> res)
        {
            TapSDKManagerHandler.Instance.OffHide(res);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnInteractiveStorageModified(res);
        }

        public static void OffInteractiveStorageModified(Action<string> res)
        {
            TapSDKManagerHandler.Instance.OffInteractiveStorageModified(res);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnKeyDown(result);
        }

        public static void OffKeyDown(Action<OnKeyDownListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffKeyDown(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnKeyUp(result);
        }

        public static void OffKeyUp(Action<OnKeyDownListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffKeyUp(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnKeyboardComplete(result);
        }

        public static void OffKeyboardComplete(Action<OnKeyboardInputListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffKeyboardComplete(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnKeyboardConfirm(result);
        }

        public static void OffKeyboardConfirm(Action<OnKeyboardInputListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffKeyboardConfirm(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnKeyboardHeightChange(result);
        }

        public static void OffKeyboardHeightChange(Action<OnKeyboardHeightChangeListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffKeyboardHeightChange(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnKeyboardInput(result);
        }

        public static void OffKeyboardInput(Action<OnKeyboardInputListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffKeyboardInput(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnMemoryWarning(result);
        }

        public static void OffMemoryWarning(Action<OnMemoryWarningListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffMemoryWarning(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnMessage(res);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnMouseDown(result);
        }

        public static void OffMouseDown(Action<OnMouseDownListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffMouseDown(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnMouseMove(result);
        }

        public static void OffMouseMove(Action<OnMouseMoveListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffMouseMove(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnMouseUp(result);
        }

        public static void OffMouseUp(Action<OnMouseDownListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffMouseUp(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnNetworkStatusChange(result);
        }

        public static void OffNetworkStatusChange(Action<OnNetworkStatusChangeListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffNetworkStatusChange(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnNetworkWeakChange(result);
        }

        public static void OffNetworkWeakChange(Action<OnNetworkWeakChangeListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffNetworkWeakChange(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnScreenRecordingStateChanged(result);
        }

        public static void OffScreenRecordingStateChanged(Action<OnScreenRecordingStateChangedListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffScreenRecordingStateChanged(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnShareMessageToFriend(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnShow(result);
        }

        public static void OffShow(Action<OnShowListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffShow(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnUnhandledRejection(result);
        }

        public static void OffUnhandledRejection(Action<OnUnhandledRejectionListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffUnhandledRejection(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnUserCaptureScreen(res);
        }

        public static void OffUserCaptureScreen(Action<GeneralCallbackResult> res)
        {
            TapSDKManagerHandler.Instance.OffUserCaptureScreen(res);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnVoIPChatInterrupted(result);
        }

        public static void OffVoIPChatInterrupted(Action<OnVoIPChatInterruptedListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffVoIPChatInterrupted(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnVoIPChatMembersChanged(result);
        }

        public static void OffVoIPChatMembersChanged(Action<OnVoIPChatMembersChangedListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffVoIPChatMembersChanged(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnVoIPChatSpeakersChanged(result);
        }

        public static void OffVoIPChatSpeakersChanged(Action<OnVoIPChatSpeakersChangedListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffVoIPChatSpeakersChanged(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnVoIPChatStateChanged(result);
        }

        public static void OffVoIPChatStateChanged(Action<OnVoIPChatStateChangedListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffVoIPChatStateChanged(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnWheel(result);
        }

        public static void OffWheel(Action<OnWheelListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffWheel(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnWindowResize(result);
        }

        public static void OffWindowResize(Action<OnWindowResizeListenerResult> result)
        {
            TapSDKManagerHandler.Instance.OffWindowResize(result);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnAddToFavorites(callback);
        }

        public static void OffAddToFavorites(Action<Action<OnAddToFavoritesListenerResult>> callback = null)
        {
            TapSDKManagerHandler.Instance.OffAddToFavorites(callback);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnCopyUrl(callback);
        }

        public static void OffCopyUrl(Action<Action<OnCopyUrlListenerResult>> callback = null)
        {
            TapSDKManagerHandler.Instance.OffCopyUrl(callback);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnHandoff(callback);
        }

        public static void OffHandoff(Action<Action<OnHandoffListenerResult>> callback = null)
        {
            TapSDKManagerHandler.Instance.OffHandoff(callback);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnShareTimeline(callback);
        }

        public static void OffShareTimeline(Action<Action<OnShareTimelineListenerResult>> callback = null)
        {
            TapSDKManagerHandler.Instance.OffShareTimeline(callback);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OnGameLiveStateChange(callback);
        }
        ...
        {
            TapSDKManagerHandler.Instance.OffGameLiveStateChange(callback);
        }
        ...
        {
            return TapSDKManagerHandler.Instance.SetHandoffQuery(query);
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetAccountInfoSync();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetAppAuthorizeSetting();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetAppBaseInfo();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetBatteryInfoSync();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetDeviceInfo();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetEnterOptionsSync();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetExptInfoSync<T>(keys);
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetExtConfigSync<T>();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetLaunchOptionsSync();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetMenuButtonBoundingClientRect();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetStorageInfoSync();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetSystemInfoSync();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetSystemSetting();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetWindowInfo();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.CreateImageData();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.CreatePath2D();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.IsPointerLocked();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.IsVKSupport(version);
        }
        ...
        {
            return TapSDKManagerHandler.Instance.SetCursor(path, x, y);
        }
        ...
        {
            return TapSDKManagerHandler.Instance.SetMessageToFriendQuery(option);
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetTextLineHeight(option);
        }
        ...
        {
            return TapSDKManagerHandler.Instance.LoadFont(path);
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetGameLiveState();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.DownloadFile(option);
        }
        ...
        {
            return TapSDKManagerHandler.Instance.CreateFeedbackButton(option);
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetLogManager(option);
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetRealtimeLogManager();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.GetUpdateManager();
        }
        ...
        {
            return TapSDKManagerHandler.Instance.CreateVideoDecoder();
        }
