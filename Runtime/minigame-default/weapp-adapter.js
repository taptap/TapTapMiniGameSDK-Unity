...
const isWK = false;
// try{
//     isWK = tj.getSystemInfoSync().renderer == 'h5';
// }catch(e){
...
/** ****/ (function (modules) {
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        function inject() {
            ...
            const _tj$getSystemInfoSync = tj.getSystemInfoSync();
            const { platform } = _tj$getSystemInfoSync;
            // 开发者工具无法重定义 window
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        const _tj$getSystemInfoSync = tj.getSystemInfoSync();
        const { screenWidth } = _tj$getSystemInfoSync;
        const { screenHeight } = _tj$getSystemInfoSync;
        const { devicePixelRatio } = _tj$getSystemInfoSync;
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        const Audio = (function (_HTMLAudioElement) {
            ...
            function Audio(url) {
                ...
                _src.set(_this, '');
                const innerAudioContext = tj.createInnerAudioContext();
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        tj.onTouchStart(touchEventHandlerFactory('touchstart'));
        tj.onTouchMove(touchEventHandlerFactory('touchmove'));
        tj.onTouchEnd(touchEventHandlerFactory('touchend'));
        tj.onTouchCancel(touchEventHandlerFactory('touchcancel'));
        /***/ 
    }),
    /* 18 */
    /***/ (function (module, exports, __webpack_require__) {
        ...
        const _util = __webpack_require__(9);
        // TODO 需要 tj.getSystemInfo 获取更详细信息
        const _tj$getSystemInfoSync = tj.getSystemInfoSync();
        const { platform } = _tj$getSystemInfoSync;
        const navigator = {
            platform,
            ...
            onLine: true,
            // TODO 用 tj.getLocation 来封装 geolocation
            geolocation: {
    ...
    /***/ (function (module, exports) {
        ...
        const WebSocket = (function () {
            ...
            function WebSocket(url) {
                ...
                const socketTask = tj.connectSocket({
                    url,
    ...
    /***/ (function (module, exports) {
        ...
        /*
             * TODO 使用 tj.readFile 来封装 FileReader
             */
    ...
    /***/ (function (module, exports) {
        ...
        const localStorage = {
            get length() {
                const _tj$getStorageInfoSyn = tj.getStorageInfoSync();
                const { keys } = _tj$getStorageInfoSyn;
                return keys.length;
            },
            key: function key(n) {
                const _tj$getStorageInfoSyn2 = tj.getStorageInfoSync();
                const { keys } = _tj$getStorageInfoSyn2;
                return keys[n];
            },
            getItem: function getItem(key) {
                return tj.getStorageSync(key);
            },
            setItem: function setItem(key, value) {
                return tj.setStorageSync(key, value);
            },
