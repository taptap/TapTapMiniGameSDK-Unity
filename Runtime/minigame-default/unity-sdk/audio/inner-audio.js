...
export default {
    // 创建audio对象
    TJCreateInnerAudioContext(src, loop, startTime, autoplay, volume, playbackRate, needDownload) {
    ...
    TJInnerAudioContextSetBool(id, k, v) {
        if (!checkHasAudio(id)) {
            return;
        }
    ...
    TJInnerAudioContextSetString(id, k, v) {
        if (!checkHasAudio(id)) {
            return;
        }
    ...
    TJInnerAudioContextSetFloat(id, k, v) {
        if (!checkHasAudio(id)) {
            return;
        }
    ...
    TJInnerAudioContextGetFloat(id, k) {
        if (!checkHasAudio(id)) {
            return 0;
        }
        return audios[id][k];
    ...
    TJInnerAudioContextGetBool(id, k) {
        if (!checkHasAudio(id)) {
            return false;
        }
        return audios[id][k];
    },
    TJInnerAudioContextPlay(id) {
        if (!checkHasAudio(id)) {
            return;
        }
    ...
    TJInnerAudioContextPause(id) {
        if (!checkHasAudio(id)) {
            return;
        }
        audios[id].pause();
    },
    TJInnerAudioContextStop(id) {
        if (!checkHasAudio(id)) {
            return;
        }
        audios[id].stop();
    },
    TJInnerAudioContextDestroy(id) {
        if (!checkHasAudio(id)) {
            return;
        }
        destroyInnerAudio(id, false);
    },
    TJInnerAudioContextSeek(id, position) {
        if (!checkHasAudio(id)) {
            return;
        }
    ...
    TJInnerAudioContextRemoveListener(id, key) {
        if (!checkHasAudio(id)) {
            return;
        }
        audios[id][key]();
    ...
    TJPreDownloadAudios(paths, id) {
        funs
            .downloadAudios(paths)
            .then(() => {
            moduleHelper.send('PreDownloadAudiosCallback', JSON.stringify({
